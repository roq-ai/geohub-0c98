...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['geotechnical-engineer', 'project-administrator', 'fieldwork-technician', 'finance-manager'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Jobs', path: '/jobs', entity: 'job', service: AccessServiceEnum.PROJECT, icon: FiTool },
