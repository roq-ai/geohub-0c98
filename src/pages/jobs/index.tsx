...
export function JobListPage(props: JobListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getJobs({
        relations: ['project', 'user', 'fieldwork_data.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('fieldwork_data', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'fieldwork_data',
          header: 'Fieldwork Data',
          accessorKey: 'fieldwork_data',
          cell: ({ row: { original: record } }: any) => record?._count?.fieldwork_data,
        }
      : null,
