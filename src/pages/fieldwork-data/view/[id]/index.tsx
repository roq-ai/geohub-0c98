...
import { getFieldworkDataById } from 'apiSdk/fieldwork-data';
import { FieldworkDataInterface } from 'interfaces/fieldwork-data';

function FieldworkDataViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                <Box>
                  ...
                  >
                    Fieldwork Data Details
                  </Text>
                </Box>
                {hasAccess('fieldwork_data', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/fieldwork-data/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Coordinates" text={data?.coordinates} />

                <FormListItem label="Elevation" text={data?.elevation} />

                <FormListItem label="Soil Profile" text={data?.soil_profile} />

                <FormListItem label="Penetrometer Results" text={data?.penetrometer_results} />
